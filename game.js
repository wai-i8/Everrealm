(function () {
  ...
  function renderStatusFacility() {
    ...
    facilityContent.innerHTML = `
      <section class="status-overview" aria-label="角色核心狀態">
        ...
        <div class="status-vitals">
          <div class="status-meter is-hp">
            <div class="status-meter-copy"><span>HP</span><b>${Math.ceil(player.hp)} / ${stats.maxHp}</b></div>
            <span class="status-progress" role="progressbar" aria-label="生命值" aria-valuemin="0" aria-valuemax="${stats.maxHp}" aria-valuenow="${Math.ceil(player.hp)}"><i style="width:${hpPercent}%"></i></span>
          </div>
          <div class="status-meter is-xp">
            <div class="status-meter-copy"><span>EXP</span><b>${player.xp} / ${xpNeeded}</b></div>
            <span class="status-progress" role="progressbar" aria-label="經驗值" aria-valuemin="0" aria-valuemax="${xpNeeded}" aria-valuenow="${player.xp}"><i style="width:${xpPercent}%"></i></span>
          </div>
        </div>

        <dl class="status-core-stats">
