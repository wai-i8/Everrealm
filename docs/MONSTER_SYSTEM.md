...
呢個 Lv 係 species / authored map progression，唔跟玩家等級動態提升。怪物 level cap 獨立為 45。
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| 山野小雞 | 1 | 1 | 120 | 120 | 95 | 15 | 教學近戰 |
| 赤尾狐 | 5 | 2 | 300 | 255 | 140 | 50 | 敏捷／雙怪 |
| 灰紋浣熊 | 10 | 1 | 450 | 450 | 170 | 55 | 平衡近戰 |
| 荒原野豬 | 15 | 3 | 750 | 525 | 195 | 75 | 三怪＋直線衝鋒 |
| 沼澤蛙 | 21 | 1 | 800 | 800 | 225 | 80 | 中距離控制 |
| 灰原郊狼 | 27 | 3 | 1000 | 700 | 275 | 105 | 三怪包位／高速 |
| 苔甲龜 | 33 | 1 | 1400 | 1400 | 355 | 190 | 坦克，高 DEF |
| 噴毒蛇 | 39 | 2 | 1200 | 1020 | 420 | 130 | 高攻、遠程毒 |
| 岩穴熊 | 45 | 1 | 2600 | 2600 | 500 | 200 | 重型高攻防 |
...
最後四捨五入成整數。呢個 encounter 倍率只作用於 HP，**唔作用於 ATK / DEF / AP / Move / Skill Speed**；怪物固定 HP、ATK、DEF 已先套用全局 ×5 尺度。
...
因此高 AP 長射程怪唔會無必要衝到玩家身邊。例如噴毒蛇 AP 未夠 `venom_spit` 時，可以先行到下一輪適合 Range 4 出招的位置並待機。
