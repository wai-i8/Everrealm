...
護士服務使用 authored-region interaction：NPC 位置以 magenta region 為準，玩家可由櫃台前方白色 walkable 區接近；互動 reach 為 `160 px`，點擊命中再加 `18 px` padding。
