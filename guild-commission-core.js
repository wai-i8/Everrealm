(function (root, factory) {
  ...
  const DEFAULT_COMMISSIONS = freeze([
    {
      ...
      recommendedLevel: 1,
      repeatable: true,
      objective: { monster_id: "chick", count: 5 },
      reward: { skill_envelope_star: 1 },
    },
    {
      ...
      recommendedLevel: 3,
      repeatable: true,
      objective: { recipient_npc_id: "mountain_delivery_recipient", count: 1 },
      reward: { skill_envelope_star: 2 },
    },
    {
      ...
      recommendedLevel: 4,
      repeatable: true,
      objective: { monster_id: "coyote", count: 5 },
      reward: { skill_envelope_star: 3 },
    },
    {
      ...
      recommendedLevel: 7,
      repeatable: true,
      objective: { monster_id: "bear", count: 5 },
      reward: { skill_envelope_star: 4 },
    },
    {
      ...
      recommendedLevel: 8,
      repeatable: true,
      objective: { monster_id: "snake", count: 5 },
      reward: { skill_envelope_star: 5 },
    },
  ]);
