(function (root, factory) {
  ...
  const MONSTERS = deepFreeze({
    chick: {
      ...
      encounter: { count: 1 },
      stats: { hp: 24, attack: 19, defense: 3 },
      combat: { moveRange: 5, role: "training_melee", skills: ["peck"] },
      rewards: { baseXp: 100, coins: 7, drops: [{ id: "bright_feather", chance: 0.25 }] },
    ...
    fox: {
      ...
      encounter: { count: 2 },
      stats: { hp: 60, attack: 28, defense: 10 },
      combat: { moveRange: 6, role: "agile_melee", skills: ["quick_bite", "fox_pounce"] },
      rewards: { baseXp: 100, coins: 10, drops: [{ id: "fox_fang", chance: 0.25 }] },
      habitat: { maps: ["field"], zones: ["mountain-road"] },
    ...
    raccoon: {
      ...
      encounter: { count: 1 },
      stats: { hp: 90, attack: 34, defense: 11 },
      combat: { moveRange: 4, role: "balanced_melee", skills: ["raccoon_claw", "flurry_claw"] },
      rewards: { baseXp: 100, coins: 16, drops: [{ id: "lantern_pelt", chance: 0.3 }] },
      habitat: { maps: ["field"], zones: ["mountain-road"] },
      questTags: ["beast", "field"],
    ...
    wild_boar: {
      ...
      encounter: { count: 3 },
      stats: { hp: 150, attack: 39, defense: 15 },
      combat: { moveRange: 4, role: "charger", skills: ["tusk_strike", "boar_charge"] },
      rewards: { baseXp: 100, coins: 15, drops: [{ id: "boar_tusk", chance: 0.28 }] },
      habitat: { maps: ["field"], zones: ["mountain-road"] },
    ...
    frog: {
      ...
      encounter: { count: 1 },
      stats: { hp: 160, attack: 45, defense: 16 },
      combat: { moveRange: 4, role: "ranged_control", skills: ["tongue_strike", "slime_shot"] },
      rewards: { baseXp: 100, coins: 26, drops: [{ id: "mist_gland", chance: 0.24 }] },
    ...
    coyote: {
      ...
      encounter: { count: 3 },
      stats: { hp: 200, attack: 55, defense: 21 },
      combat: { moveRange: 5, role: "pack_hunter", skills: ["coyote_bite", "hunting_pounce"] },
      rewards: { baseXp: 100, coins: 22, drops: [{ id: "coyote_fang", chance: 0.25 }] },
    ...
    turtle: {
      ...
      encounter: { count: 1 },
      stats: { hp: 280, attack: 71, defense: 38 },
      combat: { moveRange: 2, role: "slow_aoe", skills: ["shell_ram", "spinning_shell"] },
      rewards: { baseXp: 100, coins: 38, drops: [{ id: "moss_shell", chance: 0.28 }] },
    ...
    snake: {
      ...
      encounter: { count: 2 },
      stats: { hp: 240, attack: 84, defense: 26 },
      combat: { moveRange: 5, role: "ranged_poison", skills: ["venom_fang", "venom_spit"] },
      rewards: { baseXp: 100, coins: 34, drops: [{ id: "venom_sac", chance: 0.3 }] },
      habitat: { maps: ["dungeon"], zones: ["deep-mine"] },
    ...
    bear: {
      ...
      encounter: { count: 1 },
      stats: { hp: 520, attack: 100, defense: 40 },
      combat: { moveRange: 3, role: "heavy_bruiser", skills: ["heavy_palm", "quake_palm"] },
      rewards: { baseXp: 100, coins: 70, drops: [{ id: "bear_claw", chance: 0.25 }] },
      habitat: { maps: ["dungeon"], zones: ["deep-mine"] },
